...
THE DESTRUCTIVE RESET (user decision: pilot-phase, dev-local conversation data only; nothing
is migrated). The unified-chat rebuild replaces the SPA-driven
...
the schema never disagree. Hand-finalized rather than autogenerated.
"""

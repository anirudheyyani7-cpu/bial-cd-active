...
WHY IT IS A TOOL AND NOT A PROMPT BLOCK. The answer is ~8,300 tokens. Resident on every turn of
...
for one. Past it, each further call would append another full copy (~8,800 tokens) to a history

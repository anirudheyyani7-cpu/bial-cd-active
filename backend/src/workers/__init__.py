...
landed here, OFF for one that has never run unattended — and imports its heavy dependencies
INSIDE the task body rather than at module scope — so a disabled task costs an import of
structlog, the broker and its settings profile, and nothing else.

...
def test_chain_ends_at_a_single_linear_head() -> None:
    ...
    # past 0038_app_previous_status to 0039_connector_access (the two connector state machines:
    # `connector_access_requests`, keyed on the PERSON, and `project_connectors`, carrying each
    # project's switch and the days it reads).
    #
    ...
    assert heads == ["0039_connector_access"]

 ...
 * comment opener; both callers scan files that carry such links. A copy of this regex that lost
 * the guard would silently eat the rest of every line holding a link, and the rule reading the
 * result would go quiet rather than red — hence one shared definition, not two that can diverge.
 *

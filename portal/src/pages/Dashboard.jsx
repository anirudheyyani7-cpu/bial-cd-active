    ...
    <div className="min-h-screen font-manrope flex flex-col" style={{ background: 'linear-gradient(160deg, #ffffff 0%, #f0f9f9 100%)' }}>
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-14">
        ...
        <p className="text-neutral text-base leading-relaxed max-w-2xl mb-10">
          Ready to build the future of aviation? Jump into the App Builder to plan, build, and deploy your operational tools.
        </p>

        {/* Primary entry point — App Builder */}
        <div
          onClick={() => navigate('/workspace')}
          className="relative max-w-md rounded-2xl p-6 flex flex-col overflow-hidden cursor-pointer transition-transform hover:-translate-y-1 bg-primary text-white shadow-xl shadow-primary/20"
        >
          ...
          <p className="text-sm leading-relaxed flex-1 mb-6 text-white/80">
            Your personal space to plan, build, and manage your apps. Create, test, and refine your ideas in private.
          </p>

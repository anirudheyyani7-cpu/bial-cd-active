 ...
 * something outside chat wants a timestamp — the projects list — and then a project
 ...
 * but that module's chat list and the re-export it depended on have since been retired. The
 * one caller today is the projects list's "Details updated" column, importing it directly.
 */

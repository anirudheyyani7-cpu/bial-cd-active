...
@dataclass
class Sandbox:
    """A running sandbox container + a thin client over its Caddy ingress."""
    ...
    @property
    def sup(self) -> str:
        """The `/_sup` prefix Caddy strips before forwarding to the supervisor."""
    ...
    # --- supervisor surface (authed unless noted) ------------------------------------------
    ...
    def exec_cmd(
        ...
        """POST /_sup/exec. Returns the raw response; a non-zero `exit` is a normal 200."""
